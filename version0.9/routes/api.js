var urlShortener = require('../utils/urlShortener.js');             //Require the URL shortener utility.
...
class URL {                                                         //Setup URL class.
    constructor(urlId, origURL) {
        ...
        this.shortURL = '/' + urlShortener.shorten(urlId);          //Creates shortened url from the urlShortener utility.
    }
}
...
urls.push(new URL(123512, "https://www.amazon.com/dp/B00X4WHP5E/ref=ods_gw_ha_d_blackandwhite?pf_rd_r=QREX1YK8J8EMC8C05PYZ&pf_rd_p=da93a4f0-0b0d-45e0-bc19-b68113bc6936"));   //Adding in static URLs for version 1.
urls.push(new URL(98325, "https://play.google.com/music/m/T4ztvelxav2rehzomrwhpdpkxcu?t=Tones_Of_Home_-_Blind_Melon"));
urls.push(new URL(3438, "https://inbox.google.com"));
urls.push(new URL(232, "https://www.facebook.com"));
...
module.exports = (express) => {                     //Export the following function to be used by other modules.
    ...
    router.post('/urls', (req, res) => {
        if (req.body.url) {                         //If a URL was sent in the request body.
            postURL = new URL(2462, req.body.url);      //Creates shortened URL with the infromation submitted and the URL class.
